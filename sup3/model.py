...
def get_advance_model():
    ...
    branch_plan.add(Dense(55 * 3, activation='relu'))
    branch_plan.add(Dense(55 * 3, activation='relu'))
    
    branch_room = Sequential()
    branch_room.add(input_room)
    branch_room.add(Dense(55 * 3, activation='relu'))
    branch_room.add(Dense(55 * 3, activation='relu'))

    branch_teacher = Sequential()
    branch_teacher.add(input_teacher)
    branch_teacher.add(Dense(55 * 3, activation='relu'))
    branch_teacher.add(Dense(55 * 3, activation='relu'))
    ...
    layer_after_concat = Dense(55 * 3 * 3, activation="relu")(combined_second)
